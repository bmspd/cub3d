...
# define ESC		53
# define EAST_T		win->texture_east
# define WEST_T		win->texture_west
# define SOUTH_T	win->texture_south
# define NORTH_T	win->texture_north
# define RAY		win->ray
# define PLAYER		win->player
# define SPRITE		win->sprite
# define SPRITEi	win->spr_coords[i]
# define MAP		win->map
